...
# 拼接出绝对路径
file_path = os.path.join(script_dir, "/milvus_demo.db")

# 实例化向量数据库客户端
client = MilvusClient(
  uri=file_path, # 数据存储在本地当前目录下
)
...
# 查看 collection
print(11,client.list_collections())

# 查看 collection 描述
pprint(22,client.describe_collection(collection_name="demo_collection"))